...
| SpaceBefore               | boolean  | `true`            | If `true`, a zero width space is added before each citation in the text. This may cause trouble with line breaks. If `false`, no space is added. |

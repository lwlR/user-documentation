...
| SpaceBefore               | boolean  | `true`            | If `true`, a zero width space is added in front of each citation in the text. This can lead to sloppy line breaks in justified text. If `false`, no space is added. |  
